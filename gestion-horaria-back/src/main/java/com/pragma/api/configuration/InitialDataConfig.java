...
public class InitialDataConfig {
    ...
    public void addInitialData() {
        ...
        User userOne = User.builder()
                .email("dacoes@unicauca.edu.co")
                .name("David Camilo")
                .lastName("Collazos Escobar")
                .username("dacoes")
                .password(encoder.encode("dacoes-unicauca"))
                .roles(roleSet)
                .build();
        User userTwo = User.builder()
                .email("ppena@unicauca.edu.co")
                .name("Paula Andrea")
                .lastName("Peña Constain")
                .username("ppena")
                .password(encoder.encode("ppena-unicauca"))
                .roles(roleSet)
                .build();
